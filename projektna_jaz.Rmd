...
```{r graf_zaposlenost, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Grafi posameznih držav', fig.height=7}
graf_zaposlenost
```
...
```{r graf_regresija_zenske, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Regresija', fig.height=5}
graf_regresija_zenske

```

```{r graf_regresija_moski, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Regresija', fig.height=5}
